...
```{r print summary table, results='asis', echo = FALSE}
stargazer(
  summary_table, 
  type = 'latex', 
...
```{r randomization table, echo = FALSE, results = 'asis'}
stargazer(
...
```{r any message power analysis, echo = FALSE}
...
### Power: All Voters, Message vs. Message
...
\begin{figure}[p]
  \begin{center}
  \includegraphics[width=0.45\linewidth]{/home/rstudio/tables-figures/power_plot.pdf}
  \includegraphics[width=0.45\linewidth]{/home/rstudio/tables-figures/power_plot_by_condition.pdf}
...
```{r power-among-white-voters, echo = FALSE}
if(conduct_power == TRUE) { 
...
```{r power-among-latino-voters, echo = FALSE}
if(conduct_power == TRUE) { 
  effect_size <- seq(from=0, to = 0.025, length.out = 33)
...
```{r power-among-black-voters, echo = FALSE}
if(conduct_power == TRUE) { 
  effect_size <- seq(from=0, to = 0.025, length.out = 33)
...
\begin{figure}[p]
  \begin{center}
  \includegraphics[width=0.3\linewidth]{/home/rstudio/tables-figures/power_plot_by_group_white.pdf}
  \includegraphics[width=0.3\linewidth]{/home/rstudio/tables-figures/power_plot_by_group_latino.pdf}
  \includegraphics[width=0.3\linewidth]{/home/rstudio/tables-figures/power_plot_by_group_black.pdf}  
...
\begin{figure}[p]
  \begin{center}
  \includegraphics[width=0.3\linewidth]{/home/rstudio/tables-figures/power_plot_by_group_white_by_condition.pdf}
  \includegraphics[width=0.3\linewidth]{/home/rstudio/tables-figures/power_plot_by_group_latino_by_condition.pdf}
  \includegraphics[width=0.3\linewidth]{/home/rstudio/tables-figures/power_plot_by_group_black_by_condition.pdf}  
...
```{r print main effects of treatment models, echo = FALSE, results = 'asis'}
stargazer(
...
model_7 <- d[treat %in% 0:4 & !(historyCode2016 == 'E'), 
             felm(outcome ~ factor(treat) + factor(major_party) + 
                    race3 + age + I(age^2) | congressionalDistrict)]
...
```{r print message effects, results='asis', echo = FALSE}
stargazer(
...
```{r print subgroup effects, echo = FALSE, results = 'asis'}
stargazer(
...
```{r plot subgroup effects, echo = FALSE, results = FALSE} 
plot_subgroup(
...
```{r report message-by-subgroup, echo = FALSE, results = 'asis'}
stargazer(
...
We plot these results for ease of interpretation in Figure 7. 
...
## How many people were kept from the polls? 
...
low_and_high_ci <- effect_and_se[1] + c(-1.96, 1.96) %o% effect_and_se[2]
